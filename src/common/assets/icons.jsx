export const LinkedinIcon = ({ color = "#0288D1", size = 48, ...props }) => {
  return (
    <svg
...
export const FacebookIcon = ({ color = "#039be5", size = 48, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 48 48"
      ...
      {...props}
    >
      <path fill={color} d="M24 5A19 19 0 1 0 24 43A19 19 0 1 0 24 5Z" />
      <path
        fill="#fff"
...
export const GithubIcon = ({ color = "#181717", size = 48, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 30 30"
...
export const PortfolioIcon = ({ color = "#000000", size = 35, ...props }) => {
  return (
    <svg
      fill={color}
      height={size}
...
export const EmailIcon = ({ color = "none", size = 48, ...props }) => {
  return (
    <svg
      width={size}
      height={size}
